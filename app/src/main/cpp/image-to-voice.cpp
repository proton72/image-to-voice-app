...
#define CAM      0   /* Use OpenCV camera input No|Yes=0|1     */
...
Java_com_example_voicedecoder_MainActivity_camToVoice(JNIEnv *env, jobject object) {
   /* OpenCV variables */
  // VideoCapture cap;
   Mat gray, frame;
